...
Route::controller(FactureConsultation::class)->group(function () {
    ...
    //Route::get('/rechercheFacturesParBonDeCommande', 'rechercheFacturesParBonDeCommande')->middleware('jwt.auth');
    Route::get('/facturesParBonDeCommande', 'rechercheFacturesParBonDeCommande')->middleware('jwt.auth');
